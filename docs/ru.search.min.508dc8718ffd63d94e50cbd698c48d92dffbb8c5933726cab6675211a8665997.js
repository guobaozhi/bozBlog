...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs-use-hugo-with-hugobook-theme/flexsearch.min.js');loadScript('/docs-use-hugo-with-hugobook-theme/ru.search-data.min.5b39e0a8766e19ce363bb0bd2645e46df139a7a5dfe28707f3579f617ab7b59a.js',function(){input.required=false;search();});}
