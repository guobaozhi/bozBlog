...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs-use-hugo-with-hugobook-theme/flexsearch.min.js');loadScript('/docs-use-hugo-with-hugobook-theme/en.search-data.min.00ef0c8d473ad5623ac2d3f14137fc1ab2b82d8ab56fbed32ab8d7853fa1316b.js',function(){input.required=false;search();});}
